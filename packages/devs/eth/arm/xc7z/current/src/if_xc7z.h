//==========================================================================
//
//      devs/eth/arm/xc7z/current/src/xc7z.h
//
//      Ethernet driver header for Xilinx Zynq
//
//==========================================================================
...
#define INIT_GEM //if ecos should initialize gem
#define INIT_PHY //if ecos should initialize phy

/* MAC source defines*/
#define READ_FROM_EEPROM 1
#define SET_FROM_CDL 2
...
#define SPEED			SPEED_100

#define ZYNQ_ETH_INT_PRIO	4
#define XEMACPS0_BASE		0xE000B000 
#define XEMACPS1_BASE		0xE000C000 
...
#define XEMACPS_OCTTXL_OFFSET        0x00000100 /* Octects transmitted Low reg */
#define XEMACPS_OCTTXH_OFFSET        0x00000104 /* Octects transmitted High	reg */
#define XEMACPS_TXCNT_OFFSET         0x00000108 /* Error-free Frmaes transmitted counter */
#define XEMACPS_TXBCCNT_OFFSET       0x0000010C /* Error-free Broadcast	Frames counter*/
#define XEMACPS_TXMCCNT_OFFSET       0x00000110 /* Error-free Multicast Frame counter */
#define XEMACPS_TXPAUSECNT_OFFSET    0x00000114 /* Pause Frames Transmitted	Counter */
#define XEMACPS_TX64CNT_OFFSET       0x00000118 /* Error-free 64 byte Frames Transmitted counter */
#define XEMACPS_TX65CNT_OFFSET       0x0000011C /* Error-free 65-127 byte Frames Transmitted counter */
#define XEMACPS_TX128CNT_OFFSET      0x00000120 /* Error-free 128-255 byte Frames Transmitted counter */
#define XEMACPS_TX256CNT_OFFSET      0x00000124 /* Error-free 256-511 byte Frames transmitted counter */
#define XEMACPS_TX512CNT_OFFSET      0x00000128 /* Error-free 512-1023 byte	Frames transmitted counter */
#define XEMACPS_TX1024CNT_OFFSET     0x0000012C /* Error-free 1024-1518 byte Frames transmitted counter */
#define XEMACPS_TX1519CNT_OFFSET     0x00000130 /* Error-free larger than 1519 byte Frames transmitted counter */
#define XEMACPS_TXURUNCNT_OFFSET     0x00000134 /* TX under run error counter */
#define XEMACPS_SNGLCOLLCNT_OFFSET   0x00000138 /* Single Collision Frame Counter */
#define XEMACPS_MULTICOLLCNT_OFFSET  0x0000013C /* Multiple Collision Frame	Counter */
#define XEMACPS_EXCESSCOLLCNT_OFFSET 0x00000140 /* Excessive Collision Frame Counter */
#define XEMACPS_LATECOLLCNT_OFFSET   0x00000144 /* Late Collision Frame	Counter */
#define XEMACPS_TXDEFERCNT_OFFSET    0x00000148 /* Deferred Transmission Frame Counter */
#define XEMACPS_CSENSECNT_OFFSET     0x0000014C /* Carrier Sense Error Counter */
#define XEMACPS_OCTRXL_OFFSET        0x00000150 /* Octects Received register Low */
#define XEMACPS_OCTRXH_OFFSET        0x00000154 /* Octects Received register High */
#define XEMACPS_RXCNT_OFFSET         0x00000158 /* Error-free Frames Received Counter */
#define XEMACPS_RXBROADCNT_OFFSET    0x0000015C /* Error-free Broadcast Frames Received Counter */
#define XEMACPS_RXMULTICNT_OFFSET    0x00000160 /* Error-free Multicast	Frames Received Counter */
#define XEMACPS_RXPAUSECNT_OFFSET    0x00000164 /* Pause Frames	Received Counter */
#define XEMACPS_RX64CNT_OFFSET       0x00000168 /* Error-free 64 byte Frames Received Counter */
#define XEMACPS_RX65CNT_OFFSET       0x0000016C /* Error-free 65-127 byte Frames Received Counter */
#define XEMACPS_RX128CNT_OFFSET      0x00000170 /* Error-free 128-255 byte Frames Received Counter */
#define XEMACPS_RX256CNT_OFFSET      0x00000174 /* Error-free 256-512 byte Frames Received Counter */
#define XEMACPS_RX512CNT_OFFSET      0x00000178 /* Error-free 512-1023 byte	Frames Received Counter */
#define XEMACPS_RX1024CNT_OFFSET     0x0000017C /* Error-free 1024-1518 byte Frames Received Counter */
#define XEMACPS_RX1519CNT_OFFSET     0x00000180 /* Error-free 1519-max byte Frames Received Counter */
#define XEMACPS_RXUNDRCNT_OFFSET     0x00000184 /* Undersize Frames Received Counter */
#define XEMACPS_RXOVRCNT_OFFSET      0x00000188 /* Oversize Frames Received	Counter */
#define XEMACPS_RXJABCNT_OFFSET      0x0000018C /* Jabbers Received	Counter */
#define XEMACPS_RXFCSCNT_OFFSET      0x00000190 /* Frame Check Sequence Error Counter */
#define XEMACPS_RXLENGTHCNT_OFFSET   0x00000194 /* Length Field Error Counter */
...
#define XEMACPS_RXRESERRCNT_OFFSET   0x000001A0 /* Receive Resource Error Counter */
#define XEMACPS_RXORCNT_OFFSET       0x000001A4 /* Receive Overrun Counter */
#define XEMACPS_RXIPCCNT_OFFSET      0x000001A8 /* IP header Checksum Error	Counter */
#define XEMACPS_RXTCPCCNT_OFFSET     0x000001AC /* TCP Checksum Error Counter */
#define XEMACPS_RXUDPCCNT_OFFSET     0x000001B0 /* UDP Checksum Error Counter */
...
#define XEMACPS_PTPETXS_OFFSET       0x000001E0 /* PTP Event Frame Transmitted Seconds */
#define XEMACPS_PTPETXNS_OFFSET      0x000001E4 /* PTP Event Frame Transmitted Nanoseconds */
#define XEMACPS_PTPERXS_OFFSET       0x000001E8 /* PTP Event Frame Received	Seconds */
#define XEMACPS_PTPERXNS_OFFSET      0x000001EC /* PTP Event Frame Received	Nanoseconds */
#define XEMACPS_PTPPTXS_OFFSET       0x000001E0 /* PTP Peer Frame Transmitted Seconds */
#define XEMACPS_PTPPTXNS_OFFSET      0x000001E4 /* PTP Peer Frame Transmitted Nanoseconds */
#define XEMACPS_PTPPRXS_OFFSET       0x000001E8 /* PTP Peer Frame Received Seconds */
#define XEMACPS_PTPPRXNS_OFFSET      0x000001EC /* PTP Peer Frame Received Nanoseconds */

/* network control register bit definitions */
#define XEMACPS_NWCTRL_RXTSTAMP_MASK    0x00008000 /* RX Timestamp in CRC */
#define XEMACPS_NWCTRL_ZEROPAUSETX_MASK 0x00001000 /* Transmit zero quantum	pause frame */
#define XEMACPS_NWCTRL_PAUSETX_MASK     0x00000800 /* Transmit pause frame */
#define XEMACPS_NWCTRL_HALTTX_MASK      0x00000400 /* Halt transmission	after current frame */
#define XEMACPS_NWCTRL_STARTTX_MASK     0x00000200 /* Start tx (tx_go) */
#define XEMACPS_NWCTRL_STATWEN_MASK     0x00000080 /* Enable writing to	stat counters */
#define XEMACPS_NWCTRL_STATINC_MASK     0x00000040 /* Increment statistic registers */
#define XEMACPS_NWCTRL_STATCLR_MASK     0x00000020 /* Clear statistic registers */
...
#define XEMACPS_NWCFG_BADPREAMBEN_MASK 0x20000000 /* disable rejection of non-standard preamble */
#define XEMACPS_NWCFG_IPDSTRETCH_MASK  0x10000000 /* enable transmit IPG */
#define XEMACPS_NWCFG_FCSIGNORE_MASK   0x04000000 /* disable rejection of FCS error */
#define XEMACPS_NWCFG_HDRXEN_MASK      0x02000000 /* RX half duplex */
#define XEMACPS_NWCFG_RXCHKSUMEN_MASK  0x01000000 /* enable RX checksum offload */
#define XEMACPS_NWCFG_PAUSECOPYDI_MASK 0x00800000 /* Do not copy pause Frames to memory */
...
#define XEMACPS_NWCFG_FCSREM_MASK      0x00020000 /* Discard FCS from received frames */
#define XEMACPS_NWCFG_LENGTHERRDSCRD_MASK 0x00010000 /* RX length error discard */
...
#define XEMACPS_NWCFG_EXTADDRMATCHEN_MASK 0x00000200 /* External address match enable */
#define XEMACPS_NWCFG_1536RXEN_MASK    0x00000100 /* Enable 1536 byte frames reception */
#define XEMACPS_NWCFG_UCASTHASHEN_MASK 0x00000080 /* Receive unicast hash frames */
#define XEMACPS_NWCFG_MCASTHASHEN_MASK 0x00000040 /* Receive multicast hash	frames */
#define XEMACPS_NWCFG_BCASTDI_MASK     0x00000020 /* Do not receive	broadcast frames */
#define XEMACPS_NWCFG_COPYALLEN_MASK   0x00000010 /* Copy all frames */
#define XEMACPS_NWCFG_NVLANDISC_MASK   0x00000004 /* Receive only VLAN frames */
#define XEMACPS_NWCFG_FDEN_MASK        0x00000002 /* Full duplex */
#define XEMACPS_NWCFG_100_MASK         0x00000001 /* 10 or 100 Mbs */

/* module id register bi definitions */
#define XEMACPS_MODID_ID_MASK		0xFFFF0000
#define XEMACPS_MODID_ID_SHIFT		16
#define XEMACPS_MODID_REV_MASK		0x0000FFFF
#define XEMACPS_ID			0x0002
...
#define XEMACPS_LADDR_MACH_MASK        0x0000FFFF /* Address bits[47:32] bit[31:0] are in BOTTOM */

/* DMA control register bit definitions */
#define XEMACPS_DMACR_RXBUF_MASK     0x00FF0000 /* Mask bit for RX buffer size */
#define XEMACPS_DMACR_RXBUF_SHIFT    16         /* Shift bit for RX buffer size */
#define XEMACPS_DMACR_TCPCKSUM_MASK  0x00000800 /* enable/disable TX checksum offload */
...
#define XEMACPS_TXSR_BUFEXH_MASK     0x00000010 /* Transmit buffs exhausted	mid frame */
...
#define XEMACPS_IXR_PAUSEZERO_MASK  0x00002000	/* Pause time has reached zero */
...
#define XEMACPS_IXR_TXEXH_MASK      0x00000040	/* Transmit err occurred or	no buffers*/
...
#define XEMACPS_RXBUF_AMATCH_MASK    0x06000000 /* Specific address	matched */
...
{									\
	cyg_uint32 addr = (cyg_uint32)bdptr;						\
	addr += ((ringptr)->separation * numbd);			\
	if ((addr > (ringptr)->lastbdaddr) || ((cyg_uint32)bdptr > addr)) {	\
		addr -= (ringptr)->length;				\
	}								\
	bdptr = (zynq_eth_bd *)addr;				\
}
...
{									\
	cyg_uint32 addr = (cyg_uint32)bdptr;						\
	addr -= ((ringptr)->separation * numbd);			\
	if ((addr < (ringptr)->firstbdaddr) || ((cyg_uint32)bdptr < addr)) {	\
		addr += (ringptr)->length;				\
	}								\
	bdptr = (zynq_eth_bd *)addr;				\
}
...
#define XEMACPS_BDRING_NEXT(ringptr, bdptr)				\
	(((cyg_uint32)(bdptr) >= (ringptr)->lastbdaddr) ?			\
	(zynq_eth_bd *)(ringptr)->firstbdaddr :			\
	(zynq_eth_bd *)((cyg_uint32)(bdptr) + (ringptr)->separation))

#define XEMACPS_BDRING_PREV(ringptr, bdptr)				\
	(((cyg_uint32)(bdptr) <= (ringptr)->firstbdaddr) ?			\
	(zynq_eth_bd *)(ringptr)->lastbdaddr :			\
	(zynq_eth__bd *)((cyg_uint32)(bdptr) - (ringptr)->separation))

#define XEMACPS_SET_BUFADDR_RX(bdptr, addr)				\
	zynq_eth_write((bdptr), XEMACPS_BD_ADDR_OFFSET,		\
	((zynq_eth_read((bdptr), XEMACPS_BD_ADDR_OFFSET) &		\
	~XEMACPS_RXBUF_ADD_MASK) | (cyg_uint32)(addr)))

#define XEMACPS_BD_TO_INDEX(ringptr, bdptr)				\
	(((cyg_uint32)bdptr - (cyg_uint32)(ringptr)->firstbdaddr) / (ringptr)->separation)
