 ...
 *
 * TD changed definitions of __have_long64 and __int_fast64_t_defined to remove
 * warnings when compiling with -Wundef
 * TD changed name of the header guard to CYGONCE_HAL_STDINT_H
 */

#ifndef CYGONCE_HAL_STDINT_H
#define CYGONCE_HAL_STDINT_H
