...
#else
#define CYGHWR_HAL_STM32_SPI5_SCK               stm32_spi_altfn_out( CYGHWR_HAL_STM32_SPI5_PIN_SCK, 5, CYGHWR_HAL_STM32_SPI2_PUPD)
#define CYGHWR_HAL_STM32_SPI5_MISO              stm32_spi_altfn_in( CYGHWR_HAL_STM32_SPI5_PIN_MISO, 5 )
#define CYGHWR_HAL_STM32_SPI5_MOSI              stm32_spi_altfn_out( CYGHWR_HAL_STM32_SPI5_PIN_MOSI, 5, CYGHWR_HAL_STM32_SPI2_PUPD )
#endif
