...
#define stm32_spi_altfn_in( __port_pin, __af )           CYGHWR_HAL_STM32_PIN_ALTFN_IN( __port_pin, __af, NA, PULLUP )
#define stm32_spi_altfn_out( __port_pin, __af, __pupd )  CYGHWR_HAL_STM32_PIN_ALTFN_OUT( __port_pin, __af, PUSHPULL, __pupd, SPEED_SPI )
