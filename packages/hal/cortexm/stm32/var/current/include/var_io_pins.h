...
#define CYGHWR_HAL_STM32_GPIOA_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOA)
#define CYGHWR_HAL_STM32_GPIOB_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOB)
#define CYGHWR_HAL_STM32_GPIOC_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOC)
#define CYGHWR_HAL_STM32_GPIOD_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOD)
#define CYGHWR_HAL_STM32_GPIOE_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOE)
#define CYGHWR_HAL_STM32_GPIOF_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOF)
#define CYGHWR_HAL_STM32_GPIOG_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOG)
#define CYGHWR_HAL_STM32_GPIOH_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOH)
#define CYGHWR_HAL_STM32_GPIOI_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOI)
#define CYGHWR_HAL_STM32_GPIOJ_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOJ)
#define CYGHWR_HAL_STM32_GPIOK_CLOCK  CYGHWR_HAL_STM32_CLOCK(AHB1, GPIOK)
#endif
